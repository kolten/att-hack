...
class AppDelegate: UIResponder, UIApplicationDelegate,CLLocationManagerDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UITabBar.appearance().barTintColor = UIColor.mainWhite()
        
        //UITabBar.appearance().shadowImage = UIImage()
        //UITabBar.appearance().backgroundImage = UIImage()
        
        // Nav bar
        UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName : UIColor.mainWhite()]
        UINavigationBar.appearance().barTintColor = UIColor.mainBlue()
        UINavigationBar.appearance().tintColor = UIColor.mainWhite()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "me.koltensturgill.att_hack" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("att_hack", withExtension: "momd")!
